...
#https://huggingface.co/TehVenom/Pygmalion-7b-Merged-Safetensors/resolve/main/config.json
...
git clone --progress https://huggingface.co/TehVenom/Pygmalion-7b-Merged-Safetensors